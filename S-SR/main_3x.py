...
parser.add_argument('--model_type', type=str, default='VDSR')
parser.add_argument('--patch_size', type=int, default=120, help='Size of cropped LR image')
parser.add_argument('--pretrained_sr', default='VAE_epoch_300.pth', help='sr pretrained base model')
parser.add_argument('--pretrained', type=bool, default=False)
parser.add_argument('--save_folder', default='Model_PM2.5/', help='Location to save checkpoint models')
...
writer = SummaryWriter('./logs/ABPN')
